...
class MainForm extends Component{
  ...
  onSubmitButton=(event)=>{
    ...
    if(this.props.password != null && this.props.password.match(passwordFormat)){
      ...
      this.setState(Object.assign(this.state.errorType,{errorPasswordFormat:'*Password is weak'}));
    }

    if(this.props.password != null && this.props.confirmPassword != null){
      if(this.props.password.match(this.props.confirmPassword)){
  ...
  render(){
    return(
      ...
      <form style={formstyle}>
        ...
        <Button buttonName={this.props.submitButton} onSubmitClick={this.onSubmitButton}/>
      </form>
      {this.renderRedirect()}
      </div>
    )
